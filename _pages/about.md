...
<div class="aside">
  <head>
    <title></title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=3500, initial-scale=1">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="../images/euclid_perseus.jpg" alt="ESA Euclid observation of Perseus cluster. Credit: ESA" style="width:3500;">
        </div>
        <div class="item">
          <img src="../images/euclid_perseus.jpg" alt="ESA Euclid observation of Perseus cluster. Credit: ESA" style="width:3500;">
        </div>
